...
func SystemRoutes(r *gin.Engine) {
    ...
    corporate := r.Group("/corporate")
        ...
        corporate.POST("/2fa/register", controllers.RegisterCorporate2FA)
        corporate.POST("/2fa/enable", controllers.EnableCorporate2FA)
        corporate.POST("/2fa/verify", middlewares.TwoFAMiddleware(), controllers.VerifyCorporate2FA)
